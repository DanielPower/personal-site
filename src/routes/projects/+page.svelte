...
<div class="projects">
	<Project
		...
		links={[
			{
				name: "Repository",
				url: "https://github.com/danielpower/twatbot",
				icon: faGithub,
			},
			{
	...
	>
		<p>
			...
			link. Nitter is an alternative frontend for Twitter which does not require
			a Twitter account to view.
		</p>
		<p>
	...
	>
		...
		<p>
			...
			opposite direction. In order to recover mass you must absorb smaller orbs.
			The goal is to absorb enough mass to become the largest orb in the level.
		</p>
		<p>
	...
	>
		<p>
			...
			new Christmas themed puzzle is released. I've been participating since
			2020.
		</p>
		<p>
			I like to use Advent of Code as an opportunity to practice a new language
			or programming paradigm. In 2019 I wrote my solutions in Rust. In 2021 and
			2022 I used it as an opportunity to learn pure functional programming in
			Haskell.
		</p>
	</Project>
	...
	>
		...
		<p>
			...
			strict structure where each slice contains mutations that can only affect
			that slice. Actions that should affect multiple slices are performed using
		...
		<p>
			...
			hook to inform React of state changes. It has built-in support for Redux's
			dev tools.
		</p>
	...
	>
		<p>
			...
			given application based on which display its window is on. This is useful
			if you have a TV connected to your computer, and want to automatically
			switch the audio output to the TV when you drag a video player to it.
		</p>
		<p>
	...
	>
		<p>
			Motion is an animation library for the Love2D game framework. It includes
			a companion GUI tool for composing animations from spritesheets. Motion
			allows callbacks to be registered for animation events, such as the end of
			a loop.
		</p>
	</Project>
</div>
